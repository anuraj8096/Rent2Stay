...
export default function NotFound() {
  ...
  return (
    <div className="wrap flex min-h-[70vh] flex-col items-center justify-center py-20 text-center">
      <span className="tnum font-display text-5xl font-bold text-gray-200">404</span>
      <h1 className="mt-4 font-display text-2xl font-bold text-gray-900">This page took a wrong turn</h1>
